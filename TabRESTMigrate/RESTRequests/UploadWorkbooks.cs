...
using TabRESTMigrate.WorkbookTransforms;
...
namespace TabRESTMigrate.RESTRequests
{
    ...
    class UploadWorkbooks : TableauServerSignedInRequestBase
    {
            ...
            CredentialManager.Credential dbCredentials)
        {
            ...
            var urlFinalizeUpload = _onlineUrls.Url_FinalizeWorkbookPublish(OnlineSession, uploadSessionId, publishedContentType);
